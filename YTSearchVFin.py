...
#==============================================================================
  ...
  f = csv.writer(open("videos2_.csv", "w",newline=''),quoting=csv.QUOTE_MINIMAL)
# Write CSV Header, If you dont need that, remove this line
  f.writerow(["publishedAt","categoryId","title","kind", "id", "viewCount", "commentCount","favoriteCount"])
  for x in x:
    f.writerow([x["snippet"]["publishedAt"],
                x["snippet"]["categoryId"],
                x["snippet"]["title"].encode('cp850','replace').decode('cp850'),
                x["kind"],
                x["id"],
                x["statistics"]["viewCount"],
                x["statistics"]["commentCount"],
                x["statistics"]["favoriteCount"]])
